...
from ems.utils.csv import CSVViewMixin, DecimalEncoder

from ems.contracts.models import ProjectContract
from ems.entries.models import Entry, ProjectHours
from ems.reports.forms import (
    BillableHoursReportForm, HourlyReportForm, ProductivityReportForm,
    PayrollSummaryReportForm)
from ems.reports.utils import (
...
class HourlyReport(ReportMixin, CSVViewMixin, TemplateView):
    template_name = 'ems/reports/hourly.html'
...
class BillableHours(ReportMixin, TemplateView):
    template_name = 'ems/reports/billable_hours.html'
...
def report_estimation_accuracy(request):
    ...
    return render(request, 'ems/reports/estimation_accuracy.html', {
