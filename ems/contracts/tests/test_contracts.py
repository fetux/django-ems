...
from ems.contracts.models import ProjectContract, ContractHour
...
class ContractHourTestCase(TestCase):
    ...
    def test_get_absolute_url(self):
        ...
        url = reverse(
            'admin:contracts_contracthour_change', args=(ch.pk,), current_app='ems')
...
class ContractHourEmailTestCase(TestCase):
    ...
    def test_save_pending_calls_send_email(self):
        with mock.patch('ems.contracts.models.ContractHour._send_mail') as send_mail:
