...
from ems.contracts.forms import InvoiceForm, OutstandingHoursFilterForm
from ems.contracts.models import ProjectContract, HourGroup, EntryGroup
from ems.entries.models import Project, Entry


@cbv_decorator(permission_required('contracts.add_projectcontract'))
class ContractDetail(DetailView):
    template_name = 'ems/contract/view.html'
...
class ContractList(ListView):
    template_name = 'ems/contract/list.html'
    model = ProjectContract
...
def create_invoice(request):
    ...
    nonbillable_entries = entries.filter(activity__billable=False) \
        .select_related()
    return render(request, 'ems/invoice/create.html', {
...
def list_outstanding_invoices(request):
    ...
    return render(request, 'ems/invoice/outstanding.html', {
        'date_form': form,
...
class ListInvoices(SearchListView):
    ...
    template_name = 'ems/invoice/list.html'
...
class InvoiceDetail(DetailView):
    template_name = 'ems/invoice/view.html'
    model = EntryGroup
...
class InvoiceEntriesDetail(InvoiceDetail):
    template_name = 'ems/invoice/view_entries.html'
...
class InvoiceEdit(InvoiceDetail):
    template_name = 'ems/invoice/edit.html'
...
class InvoiceDelete(InvoiceDetail):
    template_name = 'ems/invoice/delete.html'
...
def delete_invoice_entry(request, invoice_id, entry_id):
    ...
    return render(request, 'ems/invoice/delete_entry.html', {
        'invoice': invoice,
        'entry': entry,
    })
