...
from ems.forms import DATE_FORM_FORMAT
from ems.utils.csv import DecimalEncoder
from ems.utils.views import cbv_decorator

from ems.crm.models import Project, UserProfile
from ems.entries.forms import (
    ClockInForm, ClockOutForm, AddUpdateEntryForm, ProjectHoursForm,
    ProjectHoursSearchForm)
from ems.entries.models import Entry, ProjectHours


class Dashboard(TemplateView):
    template_name = 'ems/dashboard.html'
...
def clock_in(request):
    ...
    return render(request, 'ems/entry/clock_in.html', {
        'form': form,
        'active': active_entry,
    })
...
def clock_out(request):
    ...
    return render(request, 'ems/entry/clock_out.html', {
        'form': form,
        'entry': entry,
    })
...
def create_edit_entry(request, entry_id=None):
    ...
    return render(request, 'ems/entry/create_edit.html', {
        'form': form,
        'entry': entry,
    })
...
def reject_entry(request, entry_id):
    ...
    if request.POST.get('Yes'):
        ...
        return redirect(return_url)
    return render(request, 'ems/entry/reject.html', {
        'entry': entry,
...
def delete_entry(request, entry_id):
    ...
    return render(request, 'ems/entry/delete.html', {
        'entry': entry,
    })
...
class ScheduleView(ScheduleMixin, TemplateView):
    template_name = 'ems/schedule/view.html'
...
class EditScheduleView(ScheduleMixin, TemplateView):
    template_name = 'ems/schedule/edit.html'
