...
from ems.crm.models import Business, Project, TeamMember, ProjectTeam
from ems.crm.utils import grouped_totals
...
class QuickSearch(FormView):
    ...
    template_name = 'ems/quick_search.html'
...
def reject_user_timesheet(request, user_id):
    ...
    if form.is_valid():
        ...
        if request.POST.get('yes'):
            ...
            return render(request, 'ems/user/timesheet/reject.html', {
                'date': from_date,
                'timesheet_user': user
            })
    else:
...
def view_user_timesheet(request, user_id, active_tab):
    ...
    return render(request, 'ems/user/timesheet/view.html', {
...
def change_user_timesheet(request, user_id, action):
    ...
    if not hours:
        ...
        messages.error(request, msg)
        return redirect(return_url)
    return render(request, 'ems/user/timesheet/change.html', {
        'action': action,
        'timesheet_user': user,
        'from_date': from_date,
        'to_date': to_date - relativedelta(days=1),
...
class ListBusinesses(SearchListView):
    ...
    template_name = 'ems/business/list.html'
...
class ViewBusiness(DetailView):
    ...
    template_name = 'ems/business/view.html'
...
class CreateBusiness(CreateView):
    ...
    template_name = 'ems/business/create_edit.html'
...
class DeleteBusiness(DeleteView):
    ...
    pk_url_kwarg = 'business_id'
    template_name = 'ems/delete_object.html'
...
class EditSettings(UpdateView):
    ...
    template_name = 'ems/user/settings.html'
...
class ListUsers(SearchListView):
    ...
    template_name = 'ems/user/list.html'
...
class ViewUser(DetailView):
    ...
    template_name = 'ems/user/view.html'
...
class CreateUser(CreateView):
    ...
    template_name = 'ems/user/create_edit.html'
...
class ListProjects(SearchListView):
    ...
    redirect_if_one_result = True
    search_fields = ['name__icontains', 'description__icontains']
    template_name = 'ems/project/list.html'
...
class ViewProject(DetailView):
    model = Project
    pk_url_kwarg = 'project_id'
    template_name = 'ems/project/view.html'
...
class CreateProject(CreateView):
    ...
    template_name = 'ems/project/create_edit.html'
...
class EditRelationship(RelationshipObjectMixin, UpdateView):
    model = TeamMember
    template_name = 'ems/relationship/edit.html'
...
class DeleteRelationship(RelationshipObjectMixin, DeleteView):
    model = TeamMember
    template_name = 'ems/relationship/delete.html'
