...
from ems.contracts import models as contracts
from ems.crm import models as crm
from ems.entries import models as entries
...
class ContractHour(factory.DjangoModelFactory):
    ...
    contract = factory.SubFactory('ems.tests.factories.ProjectContract')
...
class ContractAssignment(factory.DjangoModelFactory):
    ...
    user = factory.SubFactory('ems.tests.factories.User')
    contract = factory.SubFactory('ems.tests.factories.ProjectContract')
    start_date = datetime.date.today()
    end_date = datetime.date.today() + relativedelta(weeks=2)
...
class EntryGroup(factory.DjangoModelFactory):
    ...
    user = factory.SubFactory('ems.tests.factories.User')
    project = factory.SubFactory('ems.tests.factories.Project')
...
class Project(factory.DjangoModelFactory):
    ...
    business = factory.SubFactory('ems.tests.factories.Business')
    point_person = factory.SubFactory('ems.tests.factories.User')
    type = factory.SubFactory('ems.tests.factories.TypeAttribute')
    status = factory.SubFactory('ems.tests.factories.StatusAttribute')


class BillableProject(Project):
    type = factory.SubFactory('ems.tests.factories.TypeAttribute', billable=True)
    status = factory.SubFactory('ems.tests.factories.StatusAttribute', billable=True)


class NonbillableProject(Project):
    type = factory.SubFactory('ems.tests.factories.TypeAttribute', billable=False)
    status = factory.SubFactory('ems.tests.factories.StatusAttribute', billable=False)
...
class Entry(factory.DjangoModelFactory):
    ...
    user = factory.SubFactory('ems.tests.factories.User')
    activity = factory.SubFactory('ems.tests.factories.Activity')
    project = factory.SubFactory('ems.tests.factories.Project')
    location = factory.SubFactory('ems.tests.factories.Location')
